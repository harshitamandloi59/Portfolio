  ...
  const educationData = [
    {
      ...
      details: "Scored 85% with strong foundation in Mathematics and Science.",
    ...
    },
    {
      ...
      details: "Completed 12th with 87% in PCM (Physics, Chemistry, Math).",
      icon: <FaSchool size={24} />,
    },
    {
      id: 3,
      year: "2022",
      title: "Graduation (B.Sc / BCA / B.Tech)",
